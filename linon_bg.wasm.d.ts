...
export function wasm_bindgen__convert__closures__invoke1_mut__h5656483449d58596(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hf30f3b5ef1a6a59c(a: number, b: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h03f2efd3ce2d731f(a: number, b: number, c: number): void;
